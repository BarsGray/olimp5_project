        ...
        <div class="rb-news rb-page">
            <div class="rb-container">
                ...
                <?php 
				    ...
				    $width = isset($_POST['width']) ? (int) $_POST['width'] : 1000; // по умолчанию
				    ...
				    if ($width > 650) {
						...
						$max_visible = 3; // максимальное число отображаемых ссылок на мобильном устройстве
				    }
