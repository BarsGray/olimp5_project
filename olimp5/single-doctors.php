		...
		<section class="rb-doctors-page__top flex-wrap">
			<div class="rb-doctors-page__bio col-6 col-s-12">
				...
				<?php
					...
					if ($doc_id_lk) {$order_btn_params = "onclick=\"event.preventDefault(); ym(84731377, 'reachGoal', 'doctor_booking_click'); ONDOC.showModal('/booking-appointment?doctor=" . $doc_id_lk . "')\"";}
				?>
