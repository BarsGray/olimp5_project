...
/*
Template Name: Лечебные программы
*/
        ...
        <div class="rb-programms rb-page">
            <div class="rb-container">
                ...
                <ul class="rb-programms__category flex">
                    ...
                    <li class="<?php if ( is_page_template( 'template-page/page-programms-medical.php' ) ) { echo 'rb-programms__curr'; } ?>">Лечебные</li>
                </ul>
