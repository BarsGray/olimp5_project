...
/*
Template Name: Программы выходного дня
*/
        ...
        <div class="rb-programms rb-page">
            <div class="rb-container">
                ...
                <ul class="rb-programms__category flex">
                    ...
                    <li class="<?php if ( is_page_template( 'template-page/page-programms-general.php' ) ) { echo 'rb-programms__curr'; } ?>"><a href="/programms-general/">Общие программы</a></li>
                    <li class="<?php if ( is_page_template( 'template-page/page-programms-weekend.php' ) ) { echo 'rb-programms__curr'; } ?>">Выходного дня</li>
