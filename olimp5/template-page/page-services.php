...
if ( function_exists( 'carbon_get_post_meta' ) ) {
   ...
   $pages = get_pages(
    ...
    $page_id = (isset($pages) && $pages ) ? $pages[0]->ID : get_the_ID();
            ...
            <?php if ( $services_cats ) : ?>
                <div class="rb-services__list flex-wrap">
                    <?php
                        ...
                        <a href="<?php echo $rb_services_other_link; ?>" style="text-decoration:none;" class="rb-services__serv flex-wrap">
                            ...
                            <div class="rb-services__serv-text">
                                ...
                                <span href="<?php echo $rb_services_other_link; ?>" class="rb-services__serv-link rb-button__grey" style="text-decoration: auto;">
                                    Подробнее
