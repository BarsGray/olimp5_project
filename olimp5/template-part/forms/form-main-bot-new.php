<section class="rb-main__form-top rb-container">	
	<form action="" method="POST" class="rb-main__form rb-mainpage--form-bot">
		...
		<span class="rb-title">Позаботьтесь о своем здоровье с Центром Культуры Здоровья «Олимп Пять»</span>
		<p class="rb-main__form-top--subtitle">Заполните форму, и наши специалисты свяжутся с Вами! </p>
